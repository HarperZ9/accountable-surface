...
Coverage is containment, never equality of convenience:
  ...
  * a set facet (commands, origins, intents, windows) is covered when the effector's
    set is a SUBSET of the granted set;
...
SET_FACETS = frozenset({"commands", "origins", "intents", "windows"})
